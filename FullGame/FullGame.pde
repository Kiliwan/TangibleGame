...
class ImageProcessing extends PApplet {
  ...
  void setup() {
    ...
    corner1 = new KalmanFilter2D(1,10);
    corner2 = new KalmanFilter2D(1,10);
    corner3 = new KalmanFilter2D(1,10);
    corner4 = new KalmanFilter2D(1,10);
  ...
  void draw() {
    ...
    List<PVector> lines = hough(img, 100, 7, 1000);
    ...
    if(homogeneousCorners.size()!=0){
      ...
      homogeneousCorners.add(new PVector(corner1.xhat(),corner1.yhat()));
      
      corner2.predictX();
      corner2.predictY();
      
      homogeneousCorners.add(new PVector(corner2.xhat(),corner2.yhat()));

      corner3.predictX();
      corner3.predictY();
      
      homogeneousCorners.add(new PVector(corner3.xhat(),corner3.yhat()));

      corner4.predictX();
      corner4.predictY();
      
      homogeneousCorners.add(new PVector(corner4.xhat(),corner4.yhat()));
...
void drawGame() {
      ...
      if(shiftPressed == false) {
          ...
          // Ball
          ball.update(rotation.x, rotation.z);
          ball.checkEdges();
